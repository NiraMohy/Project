				...
				<div class="col-sm-9 padding-right">
					...
					<div class="category-tab"><!--category-tab-->
						...
						<div class="tab-content">
							<div class="tab-pane  active in" id="tshirt" >
								<div class="col-sm-12">
                      ...
                      <table style="width : 21sm; direction: rtl;background-color:#f0f0e9;margin-top:20px;" class=" table table-bordered">
                        <thead>
                            ...
                            <td style="font-size: 20px; width : 30%;"> الاسم</td>

                            <td style="font-size: 20px; width : 7%;">المبلغ المدفوع</td>
                            <td style="font-size: 20px; width : 7%;">التاريخ</td>
                            <td style="font-size: 20px; width : 7%;">المصاريف</td>
                            <td style="font-size: 20px; width : 7%;">القيمة الاجمالية</td>
                            
                            
                        </thead>    
                        
                      <?php
                        $stu_attendance= getAllFrom("*","installment , 	expenses  ,students",
                        "WHERE installment.Expenses_id = expenses.Expenses_id AND  installment.stu_id = students.stu_id " , "installment_id" , "ASC");
                        foreach ($stu_attendance as $stus) {
                          echo '<tr><td style="font-size: 15px;"> '. $stus['full_name'] .'</td>';

                          echo '<td style="font-size: 15px;">'. $stus['the_amount_paid'] .'</td>';
                          echo '<td style="font-size: 15px;">'. $stus['payment_date'] .'</td>';
                          echo '<td style="font-size: 15px;">'. $stus['expenses_name'] .'</td>';
                          echo '<td style="font-size: 15px;">'. $stus['value'] .'</td>';
                          echo '</tr>';
                        }
