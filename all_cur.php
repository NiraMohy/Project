			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					...
					<div class="category-tab"><!--category-tab-->
                      ...
                      <?php
                        $stu_attendance= getAllFrom("*"," 	level , courses ,departments",
                        "WHERE  courses.lev_id = level.lev_id AND departments.dep_id = courses.dep_id" , "courses_id" , "ASC");
                          foreach ($stu_attendance as $stus) {
                          echo '<tr><td style="font-size: 20px;"> '. $stus['courses_name'] .'</td>';
                          echo '<td style="font-size: 15px;"> '. $stus['lev_name'] .'</td>';
