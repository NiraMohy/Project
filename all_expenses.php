					...
					<div class="category-tab"><!--category-tab-->
                      ...
                      <table style="width : 21sm; direction: rtl;background-color:#f0f0e9;margin-top:20px;" class=" table table-bordered">
                        <thead>
                            ...
                            <td style="font-size: 10px; width : 30%;"> مصاريف</td>
                            <td style="font-size: 10px; width : 7%;">الفرقة</td>
                            <td style="font-size: 10px; width : 7%;">القسم</td>
                            <td style="font-size: 10px; width : 7%;">القيمة</td>
                            
                            
                        </thead>    
                        
                      <?php
                        $stu_attendance= getAllFrom("*","expenses , 	level  ,departments",
                        "WHERE expenses.level_id = level.lev_id AND  departments.dep_id = expenses.dep_id " , "expenses_name" , "ASC");
                        foreach ($stu_attendance as $stus) {
                          echo '<tr><td style="font-size: 15px;"> '. $stus['expenses_name'] .'</td>';
                          echo '<td style="font-size: 10px;"> '. $stus['lev_name'] .'</td>';
                          echo '<td style="font-size: 10px;"> '. $stus['dep_name'] .'</td>';
                          echo '<td style="font-size: 10px;">'. $stus['value'] .'</td>';
